...
function Header(props) {
    return (
       <Grid container  sx={{alignItems:'center',pl:'4rem',pr:'4rem',pt:'.5rem',pb:'.5rem',background:{xs:'white'},boxShadow:' 0 0 6px rgb(0 0 0 / 30%)',position:'fixed',zIndex:"999"}}>
        ...
        <Grid item xs={8.5} sx={{display:'flex',alignItems:"center",gap:'7px',cursor:'pointer',justifyContent:'end', color:'#4267B2',pr:"1rem"}}>
            {datalist.map((s,n)=><HeaderElement sx={{color:'#4267B2' }} key={n} txt={s}/> )}
            <Button href='/Signin' sx={{backgroundColor:'#4267B2',color:'white',fontFamily:'Raleway',fontSize:{lgr:'10px',lg:'11px'},pl:'1rem',pr:'1rem',textTransform:'none',borderRadius:'1rem',textAlign:'center',':hover':{backgroundColor:'white',color:'#4267B2',border:'2px solid #4267B2',borderRadius:'1rem',fontWeight:'600' }}}>Sign In </Button>
