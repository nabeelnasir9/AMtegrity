...
function PlanBoxContainer(props) {
    return (
        <Grid container sx={{justifyContent:'space-between'}}>
            <Grid item xs={1}></Grid>
            <PlanBox heading={'Free Plan'} headingcolor={'#3ac280'} free={true} value='2.81%' list={['Access to the mpartialConvert engine',"Minimum $495 initial deposit"]} ftr={'Best suited for clients that order mpartial sporadically.'}/>
